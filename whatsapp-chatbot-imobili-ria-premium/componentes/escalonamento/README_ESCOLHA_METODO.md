...
| 🥈 Manual (Imobiliária Premium) | ⭐⭐☆☆☆ | 5-7 min | Sem programação |
...
## 🥈 MÉTODO 2: Manual (Imobiliária Premium CSV)

**Importar imobili-ria-premium pronto no Google Sheets**
...
2. Arquivo → Importar → `agenda_imobili-ria-premium.csv`
...
Sabe programar?
    ├─ NÃO → Manual/Imobiliária Premium (Método 2)
    └─ SIM → Continue...
...
**Manual (Imobiliária Premium):**
```bash
# Ver: README_AGENDA_RAPIDA.md
# Importar: agenda_imobili-ria-premium.csv no Google Sheets
```
...
├── 📘 PLANILHA_AGENDA_IMOBILI-RIA-PREMIUM.md       (Documentação detalhada)
...
│
└── 📄 agenda_imobili-ria-premium.csv               (Imobiliária Premium para importar)
```
...
- Ver: `PLANILHA_AGENDA_IMOBILI-RIA-PREMIUM.md` seção "Suporte"
