...
Cliente confirma: "O primeiro"
    ↓
Redis: imóvel_ativo = "apto-savassi-001"
    ↓
...
# - Gerencia imóvel_ativo no Redis
...
**Teste 3: 2 Estágios**
- Cliente novo → sem imóvel_ativo
- Após busca → imóvel_ativo definido
