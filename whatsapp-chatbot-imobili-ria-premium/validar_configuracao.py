#!/usr/bin/env python3
"""
✅ VALIDADOR DE CONFIGURAÇÃO - chatbot-imobili-ria-premium/
...
class ValidadorConfig:
    ...
    def exibir_resumo(self, relatorio: Dict[str, List]):
        ...
        print("\n" + "=" * 70)
        if self.erros:
            print("🔴 STATUS: FALHA - Configure os imoveis com ❌ acima")
            return False
        elif self.avisos:
            print("🟡 STATUS: AVISO - Alguns imoveis opcionais não configurados")
            return True
        else:
