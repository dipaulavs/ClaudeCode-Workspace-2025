# 🚀 COMO USAR O IMOBILI-RIA-PREMIUM VALIDADO

**Este imobili-ria-premium foi 100% testado e validado no chatbot Automaia**
...
```
ferramentas/
├── lista_imoveis.py         ✅ Genérico (NOVO)
...
### 1. Testar Imobiliária Premium Base
...
```bash
cp -r chatbot-imobili-ria-premium whatsapp-chatbot-imoveis
...
# (copie de lista_imoveis.py e ajuste)
...
- [ ] Executar `test_imobili-ria-premium.py`
- [ ] Todas as dependências instaladas
- [ ] Estrutura de pastas OK

### Durante Customização

- [ ] Renomear `imoveis/` para seu negócio
- [ ] Copiar `lista_imoveis.py` → `lista_seuimóvel.py`
...
- [ ] Adicionar pelo menos 3 imoveis de teste
- [ ] Executar `test_imobili-ria-premium.py` novamente
...
### ✅ IMOBILI-RIA-PREMIUM ATUALIZADO

Este imobili-ria-premium agora contém **TODA** a estrutura validada do chatbot Automaia:
...
- Validação: `IMOBILI-RIA-PREMIUM_VALIDADO.md`
- Teste rápido: `test_imobili-ria-premium.py`
