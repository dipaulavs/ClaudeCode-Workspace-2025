    ...
    try:
        ...
        payload = {
            ...
            "messages": [{
                "role": "user",
                "content": [
                    {"type": "text", "text": "Descreva esta imagem detalhadamente (2-3 frases). Se for um carro, mencione características."},
...
def processar_mensagens_agrupadas(numero):
    ...
    try:
        ...
        if fotos:
            ...
            carro_id = resultado.get("carro_ativo", "")
            if carro_id:
                orquestrador.on_fotos_enviadas(numero, carro_id, len(fotos))
...
def health():
    ...
    return jsonify({
        "status": "online",
        "version": "4.0 - FRAMEWORK HÍBRIDO COMPLETO",
        "model": "anthropic/claude-haiku-4.5",
        "redis": redis_status,
        ...
        "features": [
            ...
            "✅ 4 Ferramentas (lista_carros, consulta_faq, tagueamento, agendar_visita)",
            "✅ Score automático (lead quente/morno/frio)",
...
if __name__ == '__main__':
    ...
    print()
    print(f"🌐 Webhook: http://localhost:5007/webhook/chatwoot")
    print(f"💚 Health: http://localhost:5007/health")
    print("=" * 70)
