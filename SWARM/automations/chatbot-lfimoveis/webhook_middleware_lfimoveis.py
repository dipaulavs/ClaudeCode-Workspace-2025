#!/usr/bin/env python3
"""
🔄 WEBHOOK MIDDLEWARE LF IMÓVEIS - CHATWOOT + EVOLUTION API
...
# URL do bot (porta 5010)
BOT_WEBHOOK_URL = "http://localhost:5010/webhook/chatwoot"
...
def webhook_evolution():
    ...
    try:
        ...
        log(f"\n{'='*80}")
        log(f"📱 WEBHOOK EVOLUTION → MIDDLEWARE LF IMÓVEIS")
        log(f"{'='*80}")
...
def webhook_chatwoot():
    ...
    try:
        ...
        log(f"\n{'='*80}")
        log(f"🔔 WEBHOOK CHATWOOT → MIDDLEWARE LF IMÓVEIS")
        log(f"{'='*80}")
...
if __name__ == '__main__':
    print("=" * 70)
    print("🔄 WEBHOOK MIDDLEWARE LF IMÓVEIS V1")
    print("=" * 70)
    print(f"🌐 Evolution Webhook: http://localhost:5011/webhook/evolution")
    print(f"🌐 Chatwoot Webhook: http://localhost:5011/webhook/chatwoot")
    print(f"💚 Health: http://localhost:5011/health")
