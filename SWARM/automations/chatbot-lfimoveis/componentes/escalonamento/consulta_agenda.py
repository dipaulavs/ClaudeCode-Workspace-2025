...
ESTRUTURA DA AGENDA:
- Aba por mês: "Janeiro 2025", "Fevereiro 2025", etc
- Colunas: Data | Horário | Cliente | Telefone | Imóvel | Status | Tipo Visita | Origem | Observações
...
AGENDA_LUCIANO_URL = "https://docs.google.com/spreadsheets/d/11dsd-2-8aBnnxzQhO1qTtXuO2bPP3Q2tVyjajMhKP1Y"
AGENDA_SPREADSHEET_ID = "11dsd-2-8aBnnxzQhO1qTtXuO2bPP3Q2tVyjajMhKP1Y"
CORRETOR_NOME = "Luciano"


def obter_nome_aba_mes(data):
    """
    Retorna nome da aba (ex: 'Janeiro 2025')

    Args:
        data: datetime ou date object

    Returns:
        str: Nome da aba no formato "Mês Ano" (ex: "Janeiro 2025")
    """
    meses = [
