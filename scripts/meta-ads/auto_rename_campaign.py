#!/usr/bin/env python3
"""
Script automático para renomear campanha Meta Ads
"""
...
def main():
    ...
    for campaign in campaigns:
        ...
        print("=" * 80)
        print("\n🚀 Aplicando alterações automaticamente...\n")
        ...
        for adset_id, info in smart_names['adsets'].items():
            try:
                ...
                print(f"❌ Erro ao atualizar adset {adset_id}: {e}")
        ...
        for ad_id, info in smart_names['ads'].items():
            try:
                ...
                print(f"❌ Erro ao atualizar ad {ad_id}: {e}")
