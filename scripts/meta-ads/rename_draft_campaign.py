#!/usr/bin/env python3
"""
Renomeia campanhas incluindo RASCUNHOS
"""
...
def get_all_campaigns():
    """Busca TODAS as campanhas (incluindo rascunhos)"""
...
def generate_names(campaign, adsets, all_ads):
    ...
    if any(word in old_name.lower() for word in ['apartamento', 'casa', 'imovel', 'cobertura']):
...
def main():
    print("\n🔍 Buscando TODAS as campanhas (incluindo rascunhos)...\n")
