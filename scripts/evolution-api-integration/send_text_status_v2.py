"""
Script para enviar status de texto (v2 - com pelo menos 1 contato)
"""
...
try:
    ...
    payload = {
        ...
        "allContacts": False,  # Enviar apenas para a lista abaixo
        "statusJidList": ["5531980160822"]  # Seu número
    }
    ...
    if response.status_code == 201 or response.status_code == 200:
        ...
        print(f"\nResposta completa:")
        print(result)
        print("\n🎉 Verifique seu status no WhatsApp!")
    else:
