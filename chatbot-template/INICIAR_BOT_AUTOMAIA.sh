...
if [ ! -f "chatwoot_config_automaia.json" ]; then
    ...
    echo ""
    echo "📝 Crie o arquivo com base no template:"
    echo "   cp chatwoot_config_automaia.json.template chatwoot_config_automaia.json"
    echo ""
...
echo ""
echo "📡 Iniciando Middleware (porta 5004)..."
...
echo ""
echo "🤖 Iniciando Chatbot Automaia (porta 5003)..."
...
echo "=============================================="
echo "   🤖 Bot:        http://localhost:5003/health"
echo "   📡 Middleware: http://localhost:5004/health"
echo ""
echo "📁 Logs:"
